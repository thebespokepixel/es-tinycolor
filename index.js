...
const rgbaToPercentageRgba = rgba => {
  ...
  var _map6 = slicedToArray(_map5, 3);
...
function hexToRgba(color) {
	...
	if (match = matchers$1.hex3.exec(color)) {
		...
		var _match$splice$map$map2 = slicedToArray(_match$splice$map$map, 3);
	...
	if (match = matchers$1.hex6.exec(color)) {
		...
		var _match$splice$map2 = slicedToArray(_match$splice$map, 3);
...
const hexToString = function hexToString(rgba) {
	let short = arguments.length <= 1 || arguments[1] === undefined ? api$2.opts.shortHex : arguments[1];
...
const hexToString$1 = function hexToString(rgba) {
	let short = arguments.length <= 1 || arguments[1] === undefined ? api$3.opts.shortHex : arguments[1];
